...
if __name__ == '__main__':
    ...
    data_class0 = [row for row in dataset if row[-1] == 0]
    data_class1 = [row for row in dataset if row[-1] == 1]
    data_class2 = [row for row in dataset if row[-1] == 2]

    train_set1 = data_class0[:int(x1 * len(data_class0))] + data_class1[:int(x1 * len(data_class1))] + \
                 data_class2[:int(x1 * len(data_class2))]
    test_set1 = data_class0[int(x2 * len(data_class0)):] + data_class1[int(x2 * len(data_class1)):] + \
                data_class2[int(x2 * len(data_class2)):]

    train_set2 = data_class0[int(x1 * len(data_class0)):int(x2 * len(data_class0))] + data_class1[
                                                                                      int(x1 * len(data_class1)):int(
                                                                                          x2 * len(data_class1))] + \
                 data_class2[int(x1 * len(data_class2)):int(x2 * len(data_class2))]

    train_set3 = data_class0[:int(x2 * len(data_class0))] + data_class1[:int(x2 * len(data_class1))] + \
                 data_class2[:int(x2 * len(data_class2))]
    ...
    test_x = [row[:-1] for row in test_set1]
    test_y = [row[-1] for row in test_set1]
    ...
    for x, y in zip(test_x, test_y):
        ...
        if pred1 == y and pred2 == y or pred2 == y and pred3 == y or pred1 == y and pred3 == y:
            acc1 += 1
